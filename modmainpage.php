...
<div id="head"> 
    ...
    if (isset($_SESSION['form_success']) && $_SESSION['form_success'] === true) {
        echo '<script type="text/javascript">
                window.onload = function () {
                    alert("You have successfully performed your operation");
                }
              </script>';
 ...
 <div id="error">
    ...
    <div class ="useradmin">
    <a href="addcontent.php" class="button">Add Content</a>
    <a href="modifycontent.php" class="button">Modify Content</a>

    <?php if ($_SESSION['rightlevel'] =='admin')
    {

    echo '<a href="delcontent.php" class="button">Delete Content</a>
